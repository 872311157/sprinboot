package com.longrise.LROA.Util;
...
public class LunarCalendar {
     ...
     * @return
     */
    public Map<String, Object> getLunarDate(int year_log, int month_log, int day_log) {
        ...
        result.put("solarCalendar", nowadays);
        try {
        ...
        //农历
        String lunarCalendar = year + "年" + month + "月" + day + "日";
        result.put("lunarCalendar", lunarCalendar);
        ...
        String datestr = "";
        if (day == 1) {
        	datestr = chineseNumber[month - 1] + "月";        	
        } else {
        	datestr = getChinaDayString(day);
        }
        result.put("holidays", holidayName);
        return result;
    }
    ...
    public static void main(String[] args) {
    	...
    	Map<String, Object> s = cal.getLunarDate(2021, 10, 1);
