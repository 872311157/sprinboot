...
public class DESService implements IEncrypt {
    private static DESService instance = new DESService();
    private static final String key = "Longrise LEAP 2008";

    public DESService() {
    }

    public static void main(String[] args) {
        System.out.println(getInstance().decrypt("DD7232518DAFC1DB363CFFF51CD599B3832E5525A676BAB1"));
    }
    ...
    public String encrypt(String str) {
        return this.strEnc(str, "Longrise LEAP 2008", (String)null, (String)null);
    }

    public String encrypt(String str, String key) {
        return this.strEnc(str, key, (String)null, (String)null);
    }

    public String decrypt(String str) {
        return this.strDec(str, "Longrise LEAP 2008", (String)null, (String)null);
    }

    public String decrypt(String str, String key) {
        return this.strDec(str, key, (String)null, (String)null);
    }

    private String strEnc(String data, String firstKey, String secondKey, String thirdKey) {
            ...
            if (leng < 4) {
                ...
                if (firstKey != null && firstKey != "" && secondKey != null && secondKey != "" && thirdKey != null && thirdKey != "") {
                    ...
                    for(x = 0; x < firstLength; ++x) {
                        tempBt = this.enc(tempBt, (int[])((int[])firstKeyBt.get(x)));
                    }

                    for(y = 0; y < secondLength; ++y) {
                        tempBt = this.enc(tempBt, (int[])((int[])secondKeyBt.get(y)));
                    }

                    for(int z = 0; z < thirdLength; ++z) {
                        tempBt = this.enc(tempBt, (int[])((int[])thirdKeyBt.get(z)));
                    }
                ...
                for(int i = 0; i < iterator; ++i) {
                    ...
                    encData = encData + this.bt64ToHex(encByte);
                }
    ...
    private String strDec(String data, String firstKey, String secondKey, String thirdKey) {
        int leng = data.length();
        String decStr = "";
        List firstKeyBt = null;
        List secondKeyBt = null;
        ...
        for(int i = 0; i < iterator; ++i) {
            ...
            if (firstKey != null && firstKey != "" && secondKey != null && secondKey != "" && thirdKey != null && thirdKey != "") {
                ...
                for(x = thirdLength - 1; x >= 0; --x) {
                    tempBt = this.dec(tempBt, (int[])((int[])thirdKeyBt.get(x)));
                }

                for(y = secondLength - 1; y >= 0; --y) {
                    tempBt = this.dec(tempBt, (int[])((int[])secondKeyBt.get(y)));
                }

                for(int z = firstLength - 1; z >= 0; --z) {
                    tempBt = this.dec(tempBt, (int[])((int[])firstKeyBt.get(z)));
                }
                ...
                for(x = secondLength - 1; x >= 0; --x) {
                    tempBt = this.dec(tempBt, (int[])((int[])secondKeyBt.get(x)));
                }

                for(y = firstLength - 1; y >= 0; --y) {
                    tempBt = this.dec(tempBt, (int[])((int[])firstKeyBt.get(y)));
                }
                ...
                for(x = firstLength - 1; x >= 0; --x) {
                    tempBt = this.dec(tempBt, (int[])((int[])firstKeyBt.get(x)));
                }
    ...
    private int[] enc(int[] dataByte, int[] keyByte) {
        ...
        for(i = 0; i < 16; ++i) {
            ...
            int[] tempRight = this.xor(this.pPermute(this.sBoxPermute(this.xor(this.expandPermute(ipRight), key))), tempLeft);
        ...
        return this.finallyPermute(key);
    }
